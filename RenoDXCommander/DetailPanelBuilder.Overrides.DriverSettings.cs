...
public partial class DetailPanelBuilder
{
    private void BuildDriverProfileSection(GameCardViewModel card, string capturedName)
    {
        ...
        if (nvidiaPresetService.IsSupported)
        {
            ...
            var vsyncLabel = new TextBlock { Text = Localizer.Get("DP_Drv_VSync"), FontSize = 11, Foreground = UIFactory.Brush(ResourceKeys.TextPrimaryBrush) };
            ...
            // VSync Mode
            {
                vsyncCol.Children.Add(new TextBlock { Text = Localizer.Get("DP_Drv_VSyncMode"), FontSize = 10, Foreground = UIFactory.Brush(ResourceKeys.TextTertiaryBrush), Margin = new Thickness(0, 2, 0, 0) });
            ...
            // VSync Tear Control
            {
                vsyncCol.Children.Add(new TextBlock { Text = Localizer.Get("DP_Drv_VSyncTearControl"), FontSize = 10, Foreground = UIFactory.Brush(ResourceKeys.TextTertiaryBrush), Margin = new Thickness(0, 2, 0, 0) });
            ...
            {
                vsyncCol.Children.Add(new TextBlock { Text = Localizer.Get("DP_Drv_LowLatency"), FontSize = 10, Foreground = UIFactory.Brush(ResourceKeys.TextTertiaryBrush), Margin = new Thickness(0, 2, 0, 0) });
            ...
            var smoothLabel = new TextBlock { Text = Localizer.Get("DP_Drv_SmoothMotion"), FontSize = 11, Foreground = UIFactory.Brush(ResourceKeys.TextPrimaryBrush) };
            ...
            {
                smoothCol.Children.Add(new TextBlock { Text = Localizer.Get("DP_Drv_SmoothMotionEnable"), FontSize = 10, Foreground = UIFactory.Brush(ResourceKeys.TextTertiaryBrush), Margin = new Thickness(0, 2, 0, 0) });
            ...
            // APIs
            {
                smoothCol.Children.Add(new TextBlock { Text = Localizer.Get("DP_Drv_SmoothMotionApis"), FontSize = 10, Foreground = UIFactory.Brush(ResourceKeys.TextTertiaryBrush), Margin = new Thickness(0, 2, 0, 0) });
            ...
            {
                smoothCol.Children.Add(new TextBlock { Text = Localizer.Get("DP_Drv_SmoothMotionFlipPacing"), FontSize = 10, Foreground = UIFactory.Brush(ResourceKeys.TextTertiaryBrush), Margin = new Thickness(0, 2, 0, 0) });
            ...
            var powerLabel = new TextBlock { Text = Localizer.Get("DP_Drv_Other"), FontSize = 11, Foreground = UIFactory.Brush(ResourceKeys.TextPrimaryBrush) };
            ...
            {
                powerCol.Children.Add(new TextBlock { Text = Localizer.Get("DP_Drv_PowerMode"), FontSize = 10, Foreground = UIFactory.Brush(ResourceKeys.TextTertiaryBrush), Margin = new Thickness(0, 2, 0, 0) });
            ...
            {
                powerCol.Children.Add(new TextBlock { Text = Localizer.Get("DP_Drv_GSync"), FontSize = 10, Foreground = UIFactory.Brush(ResourceKeys.TextTertiaryBrush), Margin = new Thickness(0, 2, 0, 0) });
            ...
            {
                Content = Localizer.Get("DP_Drv_RestoreDefaults"),
                FontSize = 11,
                Height = 32,
                HorizontalAlignment = HorizontalAlignment.Stretch,
            ...
            ToolTipService.SetToolTip(restoreProfileBtn,
                Localizer.Get("DP_Drv_RestoreDriverSettingsTip"));
            restoreProfileBtn.Click += async (s, ev) =>
            {
                var xamlRoot = (s as FrameworkElement)?.XamlRoot ?? _window.Content.XamlRoot;
                var warningDialog = new ContentDialog
                {
                    Title = Localizer.Get("DP_Drv_RestoreDriverSettingsTitle"),
                    Content = new TextBlock
                    {
                        Text = Localizer.Format("DP_Drv_RestoreDriverSettingsBody", capturedName),
                        TextWrapping = TextWrapping.Wrap,
                        FontSize = 13,
                    },
                    PrimaryButtonText = Localizer.Get("DP_Drv_RestoreDriverSettingsConfirm"),
            ...
            var rebarLabel = new TextBlock { Text = Localizer.Get("DP_Drv_ReBAR"), FontSize = 11, Foreground = UIFactory.Brush(ResourceKeys.TextPrimaryBrush) };
            ...
            {
                rebarCol.Children.Add(new TextBlock { Text = Localizer.Get("DP_Drv_ReBAREnable"), FontSize = 10, Foreground = UIFactory.Brush(ResourceKeys.TextTertiaryBrush), Margin = new Thickness(0, 2, 0, 0) });
            ...
            // Mode
            {
                rebarCol.Children.Add(new TextBlock { Text = Localizer.Get("DP_Drv_ReBARMode"), FontSize = 10, Foreground = UIFactory.Brush(ResourceKeys.TextTertiaryBrush), Margin = new Thickness(0, 2, 0, 0) });
            ...
            {
                rebarCol.Children.Add(new TextBlock { Text = Localizer.Get("DP_Drv_ReBARSizeLimit"), FontSize = 10, Foreground = UIFactory.Brush(ResourceKeys.TextTertiaryBrush), Margin = new Thickness(0, 2, 0, 0) });
